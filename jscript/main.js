...
// Document onload will run next functions
    ...
    var padval = (navheight - fsize)/2 - 5;
    var window_width = $(window).width();
    var clientcont = $("#centerblock").width();
    var padleft = (window_width - clientcont)/2;
    var sliderWidth = $(".awSlider").width();
    ...
    // set the height of the second column in about section
    var img_height = $("#imagegallery img").height();
    $("#home").css("height", img_height);
    
    // set the image height accordingly to a div in the project section top ledt image
    ...
    $(window).on('resize', function() {
        ...
        const img_height = $("#imagegallery img").height();
        $("#home").css("height", img_height);
